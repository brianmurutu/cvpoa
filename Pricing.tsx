...
const plans = [
  {
    ...
    paystackCode: 'PLN_quick_access', // replace with actual Paystack plan code
    popular: false,
  },
  {
    id: 'standard',
    ...
    paystackCode: 'PLN_standard', // replace with actual Paystack plan code
    popular: true,
  },
  {
    id: 'business',
    ...
    paystackCode: 'PLN_business', // replace with actual Paystack plan code
    popular: false,
  },
]
...
function getPriceInKobo(planId: string): number {
  ...
  // KES doesn't have sub-units so multiply by 100
  const prices: Record<string, number> = {
    quick: 3000,    // KES 30
    standard: 6000, // KES 60
    business: 15000, // KES 150
  }
